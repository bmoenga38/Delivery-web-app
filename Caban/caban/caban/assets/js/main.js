...
//   $("body").append(
//     "<a href='https://themeforest.net/checkout/84123898/create_account?_ga=2.117277253.254096395.1645587066-1382738562.1645587066' class='buy-now-btn' target='_blank'><img src='assets/img/envato.png' alt='envato'/>Buy Now</a>"
//   );
  ...
  $("select").on("change", function () {
    if ($(this).val()) $(this).css("color", "white");
  ...
  var testimonial_slider_one = new Swiper(".testimonial-slider-one", {
    ...
    speed: 1500,
    centeredSlides: true,
    pagination: { el: ".testimonial-one-pagination", clickable: true },
    breakpoints: {
      0: { slidesPerView: 1 },
      768: { slidesPerView: 2 },
    ...
    on: {
      slideChange: function () {
        ...
        let activeSlide = document.querySelector(
          `.testimonial-slider-thumbs .swiper-slide:nth-child(${activeIndex})`
        );
        let nextSlide = document.querySelector(
          `.testimonial-slider-thumbs .swiper-slide:nth-child(${
            activeIndex + 1
          })`
        );
